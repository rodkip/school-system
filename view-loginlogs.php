          ...
          <div class="col-lg-12">
            ...
            <table>
              <tr> 
                <td width="100%">
                    <br>
                  <h1 class="page-header">Login Logs:
                  </h1>
                </td>
                  ...
                  <div class="table-responsive" style="overflow-x: auto; width: 100%">
                      ...
                      <table class="table table-striped table-bordered table-hover" id="dataTable">
                        ...
                        <tbody>
                          ...
                          <?php
                        $sql="SELECT * from login_activity order by id desc" ;
                        ...
                        {               ?>
                          <tr>
                            ...
                            <td>
                              <?php echo htmlentities($row->login_time);?>
                            </td>  
                            <td>
                              <?php echo htmlentities($row->ip_address);?>
                            </td>                       
                          </tr>                 
                          <?php $cnt=$cnt+1;}} ?>                          
                        </tbody>
